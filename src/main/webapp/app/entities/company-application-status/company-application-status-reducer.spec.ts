...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './company-application-status.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPANYAPPLICATIONSTATUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPANYAPPLICATIONSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPANYAPPLICATIONSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPANYAPPLICATIONSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPANYAPPLICATIONSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPANYAPPLICATIONSTATUS actions', async () => {
      const expectedActions = [
        {
