...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ats-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATSUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_ATSUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ATSUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ATSUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ATSUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ATSUSER actions', async () => {
      const expectedActions = [
        {
