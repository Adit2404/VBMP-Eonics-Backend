...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './remark.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REMARK_LIST actions', async () => {
    ...
    it('dispatches FETCH_REMARK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REMARK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REMARK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REMARK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REMARK actions', async () => {
      const expectedActions = [
        {
