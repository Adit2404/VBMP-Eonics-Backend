...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATSAPPLICATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_ATSAPPLICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ATSAPPLICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ATSAPPLICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ATSAPPLICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ATSAPPLICATION actions', async () => {
      const expectedActions = [
        {
