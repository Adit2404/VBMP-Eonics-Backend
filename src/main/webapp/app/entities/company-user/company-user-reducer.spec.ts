...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPANYUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPANYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPANYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPANYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPANYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPANYUSER actions', async () => {
      const expectedActions = [
        {
