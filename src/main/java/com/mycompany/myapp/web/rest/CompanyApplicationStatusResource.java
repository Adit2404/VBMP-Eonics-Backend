...
import com.mycompany.myapp.repository.CompanyApplicationStatusRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.CompanyApplicationStatus}.
 */
@RestController
@RequestMapping("/api")
@Transactional
